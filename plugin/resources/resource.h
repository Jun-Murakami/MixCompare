...
// WebUI を EXE/DLL の埋め込みリソースから読み出すための ID。vite-plugin-singlefile が
// 出力する単一 index.html を main.rc で RCDATA 埋め込みし、
// MixCompare::LoadIndexHtmlForCurrentBuild が FindResource → LoadHTML で読む。
#define IDR_INDEX_HTML                  40030
